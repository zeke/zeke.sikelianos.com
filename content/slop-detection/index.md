...
description: Using Pangram to detect AI-generated content
...
Max touched on the concept of **perplexity**, a metric historically used in natural language processing. AI-generated text that is "less confusing to a language model" is said to have lower perplexity, while human-written text has qualities that surprise a language model, giving it high perplexity:
...
The results are impressively accurate: Pangram correctly identified the small handful of slop posts I published in the last few months, and even found the blobs of intermingled slop where I let an AI agent co-author parts of a post alongside me. 
...
## Pangram is incredibly accurate

I'm impressed with Pangram! The results were stunningly accurate. It cost me $6 to audit my whole site. (I could have brought that number way down if I didn't have it scan every single page in its entirety, but I just decided to go all in.)

In a time where I feel myself increasingly reliant on AI tools, I'm happy to have an ergonomic and accurate new tool to help me keep myself honest as I create new content. Gotta keep it human. :)

See [github.com/zeke/slop-detector](https://github.com/zeke/slop-detector) for code and detailed results.